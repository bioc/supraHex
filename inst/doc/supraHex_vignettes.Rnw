...
visHexMulComp(sMap,colormap="yr",title.rotate=10,gp=grid::gpar(cex=0.8))
...
visCompReorder(sMap,sReorder,colormap="yr",title.rotate=10,
...
visCompReorder(sMap, sReorder, title.rotate=10)
\end{verbatim}
...
This dataset\footnote{\url{http://www.ncbi.nlm.nih.gov/pubmed/21402797}} contains gene expression levels (15243 genes and 7 embryo stages) (see Figure~\ref{supraHex_vignettes-Xiang}).
