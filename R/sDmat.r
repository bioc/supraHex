...
#' 
#' @return 
#'  \item{dMat}{a vector with the length of nHex. It stores the distance a hexaon/rectangle is awawy from its output-space-defined neighbors in high-dimensional input space}
